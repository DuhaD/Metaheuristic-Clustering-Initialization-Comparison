...
function [Leader_score,Convergence_curve, Leader_pos]= HBOH(dim,fname,Max_iter,searchAgents)
...
Solutions=initialization_with_kmeans(searchAgents,dim,ub,lb,fname);
