...
function [Leader_score,Convergence_curve, Leader_pos]= HBOHP(dim,fname,Max_iter,searchAgents)
...
lb = 0; 
sv = 100;
fobj =@(y) GetFunction(y ,fname);        % Cost Function
SearchAgents_no = searchAgents;
Max_iteration= Max_iter; %50000 F.EV / 39 agents = 1282 iterations
...
Solutions=initialization_with_kmeans_plus(searchAgents,dim,ub,lb,fname);
